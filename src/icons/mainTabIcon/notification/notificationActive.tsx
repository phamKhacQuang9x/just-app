...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    ...
    <g id="Iconly/Light-Outline/Notification" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Notification" transform="translate(3.000000, 1.000000)" fill="#6CCA03">
...
export const notiActive = ({ width, height }: InnerProps) => (
  <SvgXml xml={xmlNotiActive} width={width} height={height} />
);
